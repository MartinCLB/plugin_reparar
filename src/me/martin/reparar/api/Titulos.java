...
public class Titulos {
	 ...
	 *            Subtitle text
	 */
	public Titulos(String title, String subtitle) {
		this.title = title;
	 ...
	 *            Fade out time
	 */
	public Titulos(String title, String subtitle, int fadeInTime, int stayTime,
			int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
	...
	public void updateTimes(Player player) {
		if (Titulos.packetTitle != null) {
			try {
				Object handle = getHandle(player);
				Object connection = getField(handle.getClass(),
						"playerConnection").get(handle);
				Object[] actions = Titulos.packetActions.getEnumConstants();
				Method sendPacket = getMethod(connection.getClass(),
						"sendPacket");
				Object packet = Titulos.packetTitle.getConstructor(
						new Class[] { Titulos.packetActions, chatBaseComponent,
			...
			try {
				...
				Object serialized = nmsChatSerializer.getConstructor(
						...
						.newInstance(
								ChatColor.translateAlternateColorCodes('&',
										this.title));
				Object packet = Titulos.packetTitle
						.getConstructor(
								new Class[] { Titulos.packetActions,
